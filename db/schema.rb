...
ActiveRecord::Schema.define(version: 2019_07_11_210804) do
  ...
  create_table "trips", force: :cascade do |t|
    ...
    t.integer "finish_place_id"
    t.integer "user_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["finish_place_id"], name: "index_trips_on_finish_place_id"
    t.index ["start_place_id"], name: "index_trips_on_start_place_id"
